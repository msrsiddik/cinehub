...
func newPayment(db *gorm.DB, opts ...gen.DOOption) payment {
	...
	_payment.PaymentID = field.NewInt32(tableName, "payment_id")
	_payment.CustomerID = field.NewInt16(tableName, "customer_id")
	_payment.StaffID = field.NewInt16(tableName, "staff_id")
	_payment.RentalID = field.NewInt32(tableName, "rental_id")
	_payment.Amount = field.NewFloat64(tableName, "amount")
	_payment.PaymentDate = field.NewTime(tableName, "payment_date")
...
func (p *payment) updateTableName(table string) *payment {
	...
	p.PaymentID = field.NewInt32(table, "payment_id")
	p.CustomerID = field.NewInt16(table, "customer_id")
	p.StaffID = field.NewInt16(table, "staff_id")
	p.RentalID = field.NewInt32(table, "rental_id")
	p.Amount = field.NewFloat64(table, "amount")
	p.PaymentDate = field.NewTime(table, "payment_date")
...
func (p *payment) fillFieldMap() {
	...
	p.fieldMap["staff_id"] = p.StaffID
	p.fieldMap["rental_id"] = p.RentalID
	p.fieldMap["amount"] = p.Amount
	p.fieldMap["payment_date"] = p.PaymentDate
}
