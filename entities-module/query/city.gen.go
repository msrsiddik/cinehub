...
func newCity(db *gorm.DB, opts ...gen.DOOption) city {
	...
	_city.CityID = field.NewInt32(tableName, "city_id")
	_city.City = field.NewString(tableName, "city")
	_city.CountryID = field.NewInt16(tableName, "country_id")
	_city.LastUpdate = field.NewTime(tableName, "last_update")
...
func (c *city) updateTableName(table string) *city {
	...
	c.CityID = field.NewInt32(table, "city_id")
	c.City = field.NewString(table, "city")
	c.CountryID = field.NewInt16(table, "country_id")
