...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.CustomerID = field.NewInt32(tableName, "customer_id")
	_customer.StoreID = field.NewInt16(tableName, "store_id")
	...
	_customer.AddressID = field.NewInt16(tableName, "address_id")
	_customer.Activebool = field.NewBool(tableName, "activebool")
	_customer.CreateDate = field.NewTime(tableName, "create_date")
	_customer.LastUpdate = field.NewTime(tableName, "last_update")
	_customer.Active = field.NewInt32(tableName, "active")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.StoreID = field.NewInt16(table, "store_id")
	...
	c.AddressID = field.NewInt16(table, "address_id")
	c.Activebool = field.NewBool(table, "activebool")
	c.CreateDate = field.NewTime(table, "create_date")
	c.LastUpdate = field.NewTime(table, "last_update")
	c.Active = field.NewInt32(table, "active")
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["activebool"] = c.Activebool
