...
func newStore(db *gorm.DB, opts ...gen.DOOption) store {
	...
	_store.StoreID = field.NewInt32(tableName, "store_id")
	_store.ManagerStaffID = field.NewInt16(tableName, "manager_staff_id")
	_store.AddressID = field.NewInt16(tableName, "address_id")
	_store.LastUpdate = field.NewTime(tableName, "last_update")
...
func (s *store) updateTableName(table string) *store {
	...
	s.StoreID = field.NewInt32(table, "store_id")
	s.ManagerStaffID = field.NewInt16(table, "manager_staff_id")
...
func (s *store) fillFieldMap() {
	...
	s.fieldMap["manager_staff_id"] = s.ManagerStaffID
